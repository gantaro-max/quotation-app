      ...
      <div style={styles.loginContainer}>
        <div style={styles.loginBox}>
          ...
          <div style={{textAlign:'left'}}>
            ...
            <input type="text" style={styles.loginInput} value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} placeholder="user@quotationapp.co.jp" onKeyPress={(e) => { if(e.key === 'Enter') handleLogin() }} />
          </div>
          <div style={{textAlign:'left'}}>
