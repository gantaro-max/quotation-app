...
この図を表示するには、GitHub や VS Code (Mermaid Preview 機能付き) などの対応ビューアが必要です。
...
| estimate_no          | VARCHAR(20)   | NOT NULL               | 見積番号 (例: Q20251201-001) |
| version              | INT           | DEFAULT 1              | 版数 (枝番)                  |
...
| grand_total          | DECIMAL(12,0) | DEFAULT 0              | 見積合計金額 (税込)          |
| issue_date           | DATE          |                        | 発行日                       |
| remarks              | TEXT          |                        | 備考                         |
